namespace BTree.UnitTest
{
    ...
    public class BTreeTest
    {
        ...
        [TestMethod]
        public void CreateBTreeWithBucket()
        {
            var btree = new BTree<string, List<int>>(Degree);

            Node<string, List<int>> root = btree.Root;
            var arrWithDocIds = new List<int>{ 1, 2, 3 };
            btree.Insert("text1", arrWithDocIds);
            btree.Insert("text2", arrWithDocIds);
            btree.Insert("text3", arrWithDocIds);
            btree.Insert("text31", arrWithDocIds);
            btree.Insert("text4", arrWithDocIds);
            btree.Insert("text41", arrWithDocIds);
            btree.Insert("text42", arrWithDocIds);
            btree.Insert("text5", arrWithDocIds);
            btree.Insert("text6", arrWithDocIds);
            btree.Insert("text3", new List<int> { 2,3,5,8,10 });
            btree.Insert("text4", new List<int> { 6,7,9 });

            var textBtree = btree.ToString();
            Console.WriteLine(textBtree);
